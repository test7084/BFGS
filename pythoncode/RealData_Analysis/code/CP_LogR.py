from  FedCSL_LogR_CI import generate_logistic_data,federated_CSL
from FedSGD_LogR_CI import federated_sgd
from FedBFGS_LogR_CI import federated_BFGS
from LocalSGD_LogR_CI import local_sgd
import numpy as np
import pandas as pd
import time
...
# print(true_w)
#X, y, true_w = generate_data(N, p,true_w, noise)
X, y, true_covariance = generate_logistic_data(N, p,true_w,noise)
print(true_w)
...
# 保存为 Excel 文件
df.to_excel('results_LogR.xlsx', index=False)